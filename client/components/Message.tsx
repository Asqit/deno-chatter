...
export default function Message(props: MessageProps) {
  ...
  if (isAuthor) {
    return (
      ...
      >
        ...
        <br />
        <span
          className={"text-black dark:text-slate-500 px-3 text-sm float-right my-2 inline-block opacity-0 transition-opacity group-hover:opacity-100"}
        >
  ...
  return (
    <li className={"inline-block animate-fade-in-up select-none"}>
      ...
      <br />
      <span className={"bg-slate-500 text-white rounded-xl p-2 select-text"}>
        {value}
      </span>
    </li>
  );
